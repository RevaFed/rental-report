...
import { LayoutDashboard, Users, Building2, Printer, FileText, User, X, LogOut } from "lucide-react";
      ...
      >
        ...
        <div className="border-b px-6 py-6">
          <div className="flex items-start justify-between">
            ...
            <button onClick={onClose} className="rounded-lg p-2 transition hover:bg-gray-100 lg:hidden" type="button">
              <X size={20} />
            </button>
          </div>
        </div>
